...
export const SOURCES: SeedSource[] = [
  ...
  { slug: "kaabtv", name: "Kaab TV", homepageUrl: "https://kaabtv.com", feedUrl: "https://kaabtv.com/feed/", kind: "REGIONAL", country: "somalia", language: "so", active: true },
  { slug: "horseed", name: "Horseed Media", homepageUrl: "https://horseedmedia.net", feedUrl: "https://horseedmedia.net/feed/", kind: "REGIONAL", country: "somalia", language: "so", active: true },
  { slug: "saxafi", name: "Saxafi Media", homepageUrl: "https://saxafimedia.com", feedUrl: "https://saxafimedia.com/feed/", kind: "REGIONAL", country: "somalia", active: true, note: "Somaliland-focused." },
  ...
  { slug: "allafrica-somalia", name: "AllAfrica", homepageUrl: "https://allafrica.com/somalia/", feedUrl: "https://allafrica.com/tools/headlines/rdf/somalia/headlines.rdf", kind: "REGIONAL", country: "somalia", active: true, note: "Syndicator. Original newsroom is credited per item. The largest of the four AllAfrica country feeds, and the steadiest overnight supply we have: Horn newsrooms file in daylight hours, so without a syndicator the visible wire goes silent from roughly midnight UTC." },
